...
public class Main {
	...
	public int addToCourse() {
		...
		String i = this.reader.next("[A-Za-z ]+");
	...
	public static void quickDemo() {
		Student stA = new Student("Steve", "1234-ABCDEF");
		Student stB = new Student("Tony", "5678-GHIJKL");
		...
		System.out.println(cA.getStudents());
		for (int i = 1; i < 35; i++) {
			Student stC = new Student("person" + i, (1000 + i) + "-FILL");
			cA.addStudent(stC);
		}
